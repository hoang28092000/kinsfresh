...
const detailPath = isIndex ? "details/detail-news.html" : "../details/detail-news.html";
const dataPath = isIndex ? "data/news.json" : "../data/news.json";
  ...
  .then((newss) => {
    ...
    if (newsList) {
      ...
      newss.forEach((news) => {
        ...
        card.href = `${detailPath}?id=${news.id}`;
